...
public class DataBaseTest {
    ...
    public void initialiseDataTest(){
        ...
        // currencies should contain 1 key (initial date), and its values
        assertEquals(1, currencies.size(), "size of the currencies should be 1");
        assertTrue(currencies.containsKey("31/08/22"));
